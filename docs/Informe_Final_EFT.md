...
<p style="text-align: justify;">Durante este semestre, mi proceso de aprendizaje estuvo marcado por dificultades persistentes en mi capacidad de retención de memoria y comprensión de conceptos abstractos de programación tradicional. Asimilar la lógica de desarrollo de software al ritmo académico convencional me resultó sumamente difícil. Ante esta realidad, decidí abordar esta asignatura enfocándome en lo que realmente importa en este ramo: la conceptualización y el diseño de Soluciones con Inteligencia Artificial. Toda la lógica del problema logístico, las reglas del negocio (fórmulas de ROP y EOQ) y el diseño funcional fueron de mi autoría, pero utilicé de forma transparente la IA como un andamiaje cognitivo y herramienta de accesibilidad para traducir esas intenciones al lenguaje estructurado de los scripts e interfaces que no lograba programar por mí mismo.</p>

<p style="text-align: justify;">Esta metodología me permitió centrar mi aprendizaje en comprender la lógica de los sistemas inteligentes: cómo funciona el almacenamiento de información semántica en la base vectorial (embeddings), la importancia de limitar el prompt de sistema (Context Bounding) para evitar que el modelo alucine datos de stock, y cómo auditar la veracidad del agente mediante métricas de observabilidad y un LLM validador (Juez). Esta experiencia me demostró que el valor de un profesional en esta nueva era de la IA no radica en la memorización mecánica de sintaxis de código, sino en la capacidad de comprender las problemáticas del negocio, liderar éticamente la configuración de las soluciones inteligentes y asegurar la veracidad de los datos resultantes.</p>

---

## 7. Declaración de Uso de Asistentes de Inteligencia Artificial

<p style="text-align: justify;">De acuerdo con las políticas del uso ético de Inteligencia Artificial de Duoc UC, se declara de forma totalmente transparente y sin reservas el uso de asistentes de IA en este entregable individual:</p>
...
<ul>
    ...
    <li style="text-align: justify; margin-bottom: 8px;"><strong>Concepto de Aplicación (Andamiaje Cognitivo)</strong>: Se declara el uso de la IA como un soporte asistencial y andamiaje cognitivo adaptativo para la estructuración y traducción de tecnicismos de programación y corrección ortográfica del informe, apoyando al alumno en la retención y aplicación de sintaxis compleja, sin delegar en la máquina la lógica, el análisis del caso de negocio ni las decisiones de diseño general del sistema.</li>
