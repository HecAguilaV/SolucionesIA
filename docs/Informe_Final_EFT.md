...
<p style="text-align: justify;">Durante el transcurso de este proyecto de carácter individual, mi proceso de aprendizaje enfrentó el desafío de asimilar y memorizar una gran cantidad de tecnicismos y sintaxis complejas en un período reducido. Ante esto, decidí utilizar la Inteligencia Artificial no como un atajo para automatizar el diseño del sistema (cuya lógica de negocio e ideas logísticas son completamente de mi autoría), sino como un andamiaje cognitivo de soporte para la traducción técnica. Esto me sirvió para materializar de forma prolija mis ideas en código estructurado y asegurar el rigor del lenguaje técnico exigido en la asignatura.</p>

<p style="text-align: justify;">Esta metodología de trabajo asistido me permitió concentrarme en la conceptualización del problema de negocio y en la validación práctica de las herramientas del agente, logrando asimilar a mi propio ritmo conceptos avanzados como el funcionamiento de los embeddings y la estructura del flujo ReAct. El uso de la IA como copiloto me ayudó a no quedar rezagado frente a la complejidad de integrar Clean Architecture y FastAPI, demostrándome que el valor de un profesional del área no radica en memorizar sintaxis mecánicamente, sino en saber formular problemas, guiar la lógica de los modelos y auditar la precisión de los resultados de forma ética y transparente.</p>
