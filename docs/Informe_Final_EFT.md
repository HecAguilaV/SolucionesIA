...
**Escribe tu reflexión personal aquí (Borrador honesto para tu edición y personalización):**
<p style="text-align: justify;">Durante el transcurso de esta asignatura y del proyecto semestral, mi proceso de aprendizaje enfrentó desafíos particulares relacionados con la asimilación de tecnicismos complejos, la retención de sintaxis y la estructuración del lenguaje formal, debido a procesos personales transitorios que han afectado mi capacidad de concentración y memoria a corto plazo. Lejos de ocultar esta dificultad, decidí abordar el desarrollo utilizando las herramientas de Inteligencia Artificial (Gemini) de una forma adaptativa: no como un atajo para automatizar el pensamiento de diseño (cuya lógica e ideas me pertenecen por completo), sino como un andamiaje cognitivo de soporte. Esto me permitió plasmar mis ideas en código estructurado y traducir los conceptos logísticos a una nomenclatura de software rigurosa.</p>

<p style="text-align: justify;">Esta metodología me enseñó el verdadero valor de la IA como tecnología asistencial. A nivel conceptual, asimilé el funcionamiento de los embeddings en ChromaDB y el control de flujo probabilístico en bucles ReAct. Mi contribución al equipo se centró en la toma de decisiones del negocio (los cálculos de ROP y EOQ) y en la validación manual del sistema en Streamlit. Utilizar la IA como puente de traducción técnica me permitió no quedar excluido de la implementación compleja de Clean Architecture y FastAPI, demostrándome que la ingeniería del futuro radica en saber guiar, bounding y auditar los modelos con honestidad intelectual.</p>

<p style="text-align: justify;">Esta experiencia me entregó una capacidad de autocrítica profunda respecto a mis propios límites y fortalezas como estudiante. Logré comprender que un buen profesional no es aquel que memoriza sintaxis de memoria de forma mecánica, sino quien sabe resolver problemas complejos y utilizar los recursos tecnológicos de forma ética, responsable y transparente para potenciar sus capacidades y asegurar el éxito del flujo de trabajo.</p>

---

## 7. Declaración de Uso de Asistentes de Inteligencia Artificial

<p style="text-align: justify;">De acuerdo con las políticas del uso ético de Inteligencia Artificial de Duoc UC, se declara de forma totalmente transparente y sin reservas el uso de asistentes de IA en este entregable:</p>
...
<ul>
    ...
    <li style="text-align: justify; margin-bottom: 8px;"><strong>Concepto de Aplicación (Andamiaje Cognitivo)</strong>: Se declara el uso de la IA como un soporte asistencial y andamiaje cognitivo adaptativo para la estructuración y traducción de tecnicismos de programación y corrección ortográfica del informe, compensando dificultades transitorias de retención del alumno sin delegar en la máquina la lógica, el análisis del caso de negocio ni las decisiones del diseño general del sistema.</li>
