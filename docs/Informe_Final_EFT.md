...
<p style="text-align: justify;">Durante este semestre, mi proceso de aprendizaje estuvo marcado por dificultades severas y persistentes en mi capacidad de retención, concentración y comprensión de tecnicismos complejos de programación. Asimilar conceptos abstractos de ingeniería de software a la par del ritmo académico tradicional me resultó sumamente difícil. En lugar de ocultar o evadir esta limitación cognitiva, decidí afrontar el proyecto integrando la Inteligencia Artificial de forma transparente como una herramienta de accesibilidad y andamiaje cognitivo. Toda la lógica de negocio, las decisiones de inventario (cálculos de ROP y EOQ) y el diseño conceptual de la solución nacieron de mis ideas, pero la IA fue el puente indispensable que me permitió traducir y estructurar ese pensamiento en la sintaxis compleja de FastAPI y en el lenguaje técnico formal que se me exigía y que mi memoria no lograba almacenar por sí sola.</p>

<p style="text-align: justify;">Esta experiencia transformó mi perspectiva sobre la tecnología y la educación. Comprender el funcionamiento interno de los embeddings en ChromaDB o el bucle ReAct no fue un proceso lineal para mí; requirió de múltiples iteraciones donde utilicé el modelo como un tutor adaptativo que me explicaba las cosas a mi propio ritmo. El valor de este trabajo no radica en una supuesta memorización mecánica de código que no logré retener, sino en mi honestidad y perseverancia para liderar y validar una solución de arquitectura limpia (Clean Architecture) apoyándome éticamente en la tecnología disponible para nivelar mis limitaciones cognitivas y asegurar un resultado profesional.</p>
